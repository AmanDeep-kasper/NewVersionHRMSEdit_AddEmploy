...
const ManagerReviewTask = () => {
  ...
  const reviewTasks = tasks.filter(
    (task) =>
      ...
      task.employees?.some((emp) => emp.empTaskStatus === "In Review")
  );
    ...
    return (
      ...
      >
        ...
        <p className="text-muted mb-0" style={{ maxWidth: "420px" }}>
          There are currently no tasks waiting for your review.
        </p>
      </div>
    );
  }
  ...
  const calculateProgress = (task) => {
    ...
    const completed = validEmployees.filter(
...
export default ManagerReviewTask;
