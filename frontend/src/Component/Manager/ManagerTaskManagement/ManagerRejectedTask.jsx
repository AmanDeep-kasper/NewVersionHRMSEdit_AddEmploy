...
const ManagerRejectedTask = () => {
  ...
  const rejectedTasks = tasks.filter(
    (task) => task.status === "Rejected" && task.managerEmail?.Email === email
  );
    ...
    return (
      ...
      >
        ...
        <p className="text-muted mb-0" style={{ maxWidth: "420px" }}>
          There are currently no tasks rejected by you.
        </p>
      </div>
    );
  }
                ...
                <div key={task._id} className="col-lg-6 col-xl-4">
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: "12px",
                      overflow: "hidden",
                      borderBottom: "3px solid #dc2626", // red accent for rejected
                    }}
                    onMouseEnter={(e) => {
                  ...
                  >
                    ...
                    <div className="card-body px-4 pb-4 pt-3 d-flex flex-column">
                      ...
                      {/* Rejection notice */}
                      <div className="alert alert-danger alert-sm mb-3 py-2 px-3">
                        <strong>Rejected by you</strong>
                        <div className="small mt-1">
                          Please communicate any discrepancies to the assigned
                          employees.
                        </div>
                      </div>
