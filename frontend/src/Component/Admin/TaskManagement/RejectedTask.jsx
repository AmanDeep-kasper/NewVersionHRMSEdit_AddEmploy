            ...
            .map((task) => (
              ...
              >
                <div className="card" style={{
                  borderBottom: "2px solid #BF1722", background: darkMode ? "transparent" : "rgb(43, 44, 44)",
                  color: darkMode ? "#3c3c3c" : "#f2f2f2"
                }}>
                  <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                    <h5 class="text-info fw-medium">{task.taskID}</h5>
                        ...
                        {/* <div className="col-6">
                          <div>
                            <div className="d-flex align-items-center justify-content-between mb-1">
                              <small className="">54% Completed</small>
                            </div>
                      ...
                      {task.status === "Rejected" && (
                        <span className="border border-danger px-2 py-1 text-center">
                          ...
                          <span className="text-danger">
                            {" "}
                            {task.managerEmail.FirstName}  {task.managerEmail.LastName}
                          </span>
                          . Please communicate any discrepancies you encounter.
                        </span>
                      )}
                    </div>
                  </div>
