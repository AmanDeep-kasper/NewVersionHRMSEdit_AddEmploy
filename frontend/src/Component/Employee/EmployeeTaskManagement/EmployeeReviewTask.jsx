                        ...
                        <div className="d-flex flex-column gap-2 my-2">
                          {task.employees.some(emp => emp.empTaskStatus === "Verified") && (
                            ...
                            >
                              ...
                              You have successfully completed your task, but the team’s progress is still pending.
                              </p>
                            </span>
                          )}
                          {task.employees.some(emp => emp.empTaskStatus === "In Review") && (
                            ...
                            Your task is in verification, but your team member's task is still pending.
                            </span>
                          )}
                        </div>
