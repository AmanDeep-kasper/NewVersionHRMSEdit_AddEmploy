...
const RequestRaisedClosed = () => {
  ...
  const [ClosedReOpen, isClosedReOpen] = useState(false);
  ...
  const handleSaveRemark = () => {
    ...
    const dataToSend = {
      ...
      status: "Open", // Change status to Close
    };
        ...
        >
          <div className="mb-3">
            <TittleHeader
              ...
              numbers={data.length}
              message={"You can view all your closed requests here"}
            />
          </div>
                            ...
                            placeholder={`${
                              ClosedReOpen
                                ...
                                : isCompleteButtonDisabled(
                                  ...
                                  ? "This request is closed and cannot be reopened."
...
export default RequestRaisedClosed;
