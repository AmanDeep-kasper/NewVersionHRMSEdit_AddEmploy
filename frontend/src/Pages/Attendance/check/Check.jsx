...
function Check({ data, today, weekly, monthly,treatOnLeaveAsWorkable = true }) {
  ...
  useEffect(() => {
    ...
    const fetchAttendanceData = async () => {
      ...
      try {
        ...
        // Backend returns a wrapped response with { userId, FirstName, ..., attendance: {...} }
...
const weeklyWorkedHoursDecimal = (() => {
  try {
    if (viewMode === 'weekly' && typeof netLogin === 'number' && !Number.isNaN(netLogin)) {
...
const monthDisplayActualDecimal = (() => {
  if (typeof netLogin === 'number' && !Number.isNaN(netLogin)) return netLogin / 60; // netLogin is minutes
  if (typeof actualMonthlyHours === 'number' && !Number.isNaN(actualMonthlyHours)) return actualMonthlyHours;
  if (totalsMonthlyRender && typeof totalsMonthlyRender.netMinutes === 'number') return totalsMonthlyRender.netMinutes / 60;
  return null;
})();
...
const monthDisplayActualH = monthDisplayActualDecimal !== null ? (typeof monthDisplayActualDecimal === 'number' ? Number(monthDisplayActualDecimal).toFixed(2) : '--') : '--';
    ...
    <Container fluid className="p-4" style={{ background: "#f3f4f6" }}>
              ...
              <Card className="h-100">
                <Card.Body className="d-flex flex-column justify-content-between">
                  ...
                  <div className="mt-3 pt-3 border-top">
                    ...
                    {(() => {
                      // Expected break for today (in minutes): typically 60 min per 8-hour shift
                      // Actual break from attendance: use totalsTodayRender.breakMinutes
                      const expectedBreakMinutes = (apiShiftToday && typeof apiShiftToday.expectedMinutes === 'number')
                        ? Math.max(0, apiShiftToday.expectedMinutes - (8 * 60)) // rough estimate: full shift minus 8 hours
                      ...
                      const actualBreakMinutes = (totalsTodayRender && typeof totalsTodayRender.breakMinutes === 'number')
                        ...
                        : (todayData?.today?.breakMinutes || 0);
                ...
                <Card.Body className="d-flex flex-column justify-content-between">
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <div className="d-flex justify-content-between mt-1 small text-muted">
                        <span>{`Worked (net): ${(typeof netWeekly === 'number') ? formatHoursDotFromMinutes(netWeekly) : (weekDisplayActualDecimal !== null ? Number(weekDisplayActualDecimal).toFixed(2) : '--')} hrs`}</span>
                        <span>
                  ...
                  <div className="d-flex align-items-center mt-3">
                    {(() => {
                      // Compute diff as: shift expected - worked (user requested)
                      if (weekDisplayActualDecimal !== null && weekDisplayExpectedDecimal !== null) {
                        const diff = weekDisplayExpectedDecimal - weekDisplayActualDecimal;
                        const abs = Math.abs(diff).toFixed(2);
                        // If diff > 0 => worked less than shift (missing hours) => show red down with -abs
                        if (diff > 0) {
                          return (
                            <div className="d-flex align-items-center text-danger">
                              <FiArrowDown className="me-1" />
                        ...
                        // diff <= 0 => worked >= shift (on time or overtime) => show green up with +abs
                        return (
                          <div className="d-flex align-items-center text-success">
                            <FiArrowUp className="me-1" />
                            <small className="mb-0">{`+${abs} hrs`}</small>
                  ...
                  <div className="mt-3 pt-3 border-top">
                    ...
                    {(() => {
                      // Expected weekly break: roughly 1 hour per working day
      ...
      {/* <Col xs={12} md={4}>
        <Card className="shadow-sm rounded-3">
          <Card.Body>
            <h5 className="mb-3">Weekly Summary</h5>

            <div className="d-flex justify-content-between mb-2">
              <strong>Worked:</strong>
              <span>{formatMinutes(weekly?.workedMinutes)}</span>
            </div>

            <div className="d-flex justify-content-between mb-2">
              <strong>Break:</strong>
              <span>{formatMinutes(weekly?.breakMinutes)}</span>
            </div>

            <div className="d-flex justify-content-between">
              <strong>Net Working:</strong>
              <span>{formatMinutes((weekly?.workedMinutes || 0) - (weekly?.breakMinutes || 0))}</span>
            </div>
          </Card.Body>
        </Card>
      </Col> */}
              ...
              <Card className="h-100">
                <Card.Body className="d-flex flex-column justify-content-between">
                  ...
                  <div className="mt-3 pt-3 border-top">
                    ...
                    {(() => {
                      // Expected monthly break: roughly 1 hour per working day (~26 days)
            ...
            {/* Break metrics: expected shift break vs actual break taken (monthly) */}
            <div style={{display: 'none'}} /> {/* placeholder for clarity */}
...
//               <div className="d-flex align-items-center text-muted mb-3">
//                 <FiClock size={16} className="me-2" />
//                 <small>Punch In at 10.00 AM</small>
//               </div>
...
//               <div>
//                 <h3 className="mb-0">
//                   {actualTodayHours !== null && expectedTodayHours !== null
//                     ? `${actualTodayHours} / ${expectedTodayHours}`
...
//                 <FiArrowUp className="me-1" />
//                 <small className="mb-0">{dailyDiffHours !== null ? `Diff: ${dailyDiffHours} hrs` : 'Today vs Shift'}</small>
//               </div>
//             </Card.Body>
//           </Card>
//         </Col>
...
//               <div>
//                 <h3 className="mb-0">
//                   {actualWeeklyHours !== null && expectedWeeklyHours !== null
//                     ? `${actualWeeklyHours} / ${expectedWeeklyHours}`
//                     : '-- / --'}
//                 </h3>
//                 <small className="text-muted">Total Hours Week</small>
//               </div>

//               <div className="d-flex align-items-center mt-3 text-success">
//                 <FiArrowUp className="me-1" />
//                 <small className="mb-0">7% Last Week</small>
//               </div>
//             </Card.Body>
//           </Card>
//         </Col>
...
//               <div>
//                 <h3 className="mb-0">
//                   {actualMonthlyHours !== null && expectedMonthlyHours !== null
//                     ? `${actualMonthlyHours} / ${expectedMonthlyHours}`
//                     : '-- / --'}
//                 </h3>
//                 <small className="text-muted">Total Hours Month</small>
//               </div>
...
//               <div className="d-flex align-items-center mt-3 text-danger">
//                 <FiArrowDown className="me-1" />
//                 <small className="mb-0">8% Last Month</small>
//               </div>
//             </Card.Body>
//           </Card>
//         </Col>
...
// //           <div className="text-center mb-3">
// //             <h5 className="mb-0">Good Morning, Afroz</h5>
// //             <small className="text-muted">08:35 AM, 11 Mar 2025</small>
// //           </div>
...
// //           {/* Buttons With Gap */}
// //           <div className="w-100 mt-auto d-flex flex-column gap-2">
// //             <Button variant="success" className="w-100 rounded-pill py-2">
// //               Login
// //             </Button>

// //             <Button variant="dark" className="w-100 rounded-pill py-2">
// //               Logout
// //             </Button>
// //           </div>
...
// //             <Card.Body className="d-flex flex-column justify-content-between">
// //               <div>
// //                 <h3 className="mb-0">10 / 40</h3>
// //                 <small className="text-muted">Total Hours Week</small>
// //               </div>
// //               <div className="d-flex align-items-center mt-3 text-success">
// //                 <FiArrowUp className="me-1" />
// //                 <small>7% Last Week</small>
// //               </div>
// //             </Card.Body>
// //           </Card>
// //         </Col>
...
// //             <Card.Body className="d-flex flex-column justify-content-between">
// //               <div>
// //                 <h3 className="mb-0">75 / 98</h3>
// //                 <small className="text-muted">Total Hours Month</small>
// //               </div>
// //               <div className="d-flex align-items-center mt-3 text-danger">
// //                 <FiArrowDown className="me-1" />
// //                 <small>8% Last Month</small>
// //               </div>
// //             </Card.Body>
// //           </Card>
// //         </Col>
...
// //               <div>
// //                 <h3 className="mb-0">16 / 28</h3>
// //                 <small className="text-muted">Overtime Month</small>
// //               </div>
// //               <div className="d-flex align-items-center mt-3 text-danger">
// //                 <FiArrowDown className="me-1" />
// //                 <small>6% Last Month</small>
// //               </div>
// //             </Card.Body>
// //           </Card>
// //         </Col>
...
//                 <img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-27.jpg" alt="Img" />
//               </div>
//             </div>
...
//                   <span className="avatar avatar-sm bg-primary mb-2"><i className="ti ti-clock-stop" /></span>
...
//               <div className="card-body">
//                 <div className="border-bottom mb-2 pb-2">
//                   <span className="avatar avatar-sm bg-dark mb-2"><i className="ti ti-clock-up" /></span>
...
//               <div className="card-body">
//                 <div className="border-bottom mb-2 pb-2">
//                   <span className="avatar avatar-sm bg-info mb-2"><i className="ti ti-calendar-up" /></span>
...
//               <div className="card-body">
//                 <div className="border-bottom mb-2 pb-2">
//                   <span className="avatar avatar-sm bg-pink mb-2"><i className="ti ti-calendar-star" /></span>
...
//                     <div className="mb-3">
//                       <p className="d-flex align-items-center mb-1"><i className="ti ti-point-filled text-dark-transparent me-1" />Total Working hours</p>
//                       <h3>12h 36m</h3>
//                     </div>
//                   </div>
//                   <div className="col-xl-3">
//                     <div className="mb-3">
//                       <p className="d-flex align-items-center mb-1"><i className="ti ti-point-filled text-success me-1" />Productive Hours</p>
//                       <h3>08h 36m</h3>
//                     </div>
//                   </div>
//                   <div className="col-xl-3">
//                     <div className="mb-3">
//                       <p className="d-flex align-items-center mb-1"><i className="ti ti-point-filled text-warning me-1" />Break hours</p>
//                       <h3>22m 15s</h3>
//                     </div>
//                   </div>
//                   <div className="col-xl-3">
//                     <div className="mb-3">
//                       <p className="d-flex align-items-center mb-1"><i className="ti ti-point-filled text-info me-1" />Overtime</p>
//                       <h3>02h 15m</h3>
//                     </div>
//                   </div>
//                 </div>
//                 <div className="row">
//                   <div className="col-md-12">
//                     <div className="progress bg-transparent-dark mb-3" style={{height: 24}}>
//                       <div className="progress-bar bg-white rounded" role="progressbar" style={{width: '18%'}} />
//                       <div className="progress-bar bg-success rounded me-2" role="progressbar" style={{width: '18%'}} />
//                       <div className="progress-bar bg-warning rounded me-2" role="progressbar" style={{width: '5%'}} />
//                       <div className="progress-bar bg-success rounded me-2" role="progressbar" style={{width: '28%'}} />
//                       <div className="progress-bar bg-warning rounded me-2" role="progressbar" style={{width: '17%'}} />
//                       <div className="progress-bar bg-success rounded me-2" role="progressbar" style={{width: '22%'}} />
//                       <div className="progress-bar bg-warning rounded me-2" role="progressbar" style={{width: '5%'}} />
//                       <div className="progress-bar bg-info rounded me-2" role="progressbar" style={{width: '3%'}} />
//                       <div className="progress-bar bg-info rounded" role="progressbar" style={{width: '2%'}} />
//                       <div className="progress-bar bg-white rounded" role="progressbar" style={{width: '18%'}} />
//                     </div>
//                   </div>
...
//                     <i className="ti ti-point-filled me-1" />Present
//                   </span>
//                 </td>
//                 <td>
//                   06:45 PM
...
//                     <i className="ti ti-clock-hour-11 me-1" />8.55 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                     <i className="ti ti-clock-hour-11 me-1" />7.54 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />8.45 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />8.35 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />8.22 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />8.32 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                     <i className="ti ti-clock-hour-11 me-1" />9.15 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />8.35Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
...
//                     <i className="ti ti-point-filled me-1" />Absent
//                   </span>
//                 </td>
//                 <td>
//                   09:23 PM
...
//                 <td>
//                   <span className="badge badge-success d-inline-flex align-items-center">
//                     <i className="ti ti-clock-hour-11 me-1" />9.25 Hrs
//                   </span>
//                 </td>										
//               </tr>
//               <tr>
