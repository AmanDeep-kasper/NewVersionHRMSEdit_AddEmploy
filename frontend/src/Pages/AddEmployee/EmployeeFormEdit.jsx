...
const EmployeeFormEdit = (props) => {
  ...
  // edit by aman steps for the form
  ...
  // const upperAlphaNumeric = (v) => v.replace(/[^A-Z0-9]/gi, "").toUpperCase();
      ...
      <Form
        ...
        onSubmit={(e) => {
          ...
          props.onEmployeeEditUpdate(props.editData, {
            ...
            fullFinal,
            status,
            departmentId: props.editData?.department?.[0]?._id,
            positionId: props.editData?.position?.[0]?._id,
            reportingManager: props.editData?.reportManager,
            reportingHr: props.editData?.reportHr,
        ...
        <div className="d-flex">
          ...
          <div style={{ width: "260px", flexShrink: 0 }}>
            {/* <div className="mb-3 text-muted">0/3 Completed</div> */}
            {/* strip start */}
